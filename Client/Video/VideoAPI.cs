...
namespace Client
{
    public class VideoAPI  //视频API类
    {
        ...
        [DllImport("gdi32")]
        public static extern IntPtr CreateDIBitmap(IntPtr hDC, ref BITMAPINFOHEADER lpInfoHeader, int dwUsage, byte[] lpInitBits, ref BITMAPINFO lpInitInfo, int wUsage); 
        #endregion
