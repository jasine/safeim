    ...
    class VoiceCapture
    {
        ...
        private void CreateCaptureBuffer()
        {
            ...
            catch (Exception e)
            {
                ...
                MessageBox.Show("VoiceCapture,cs line 200  " + e.ToString());
            }
        ...
        private void RecordCapturedData(Socket Client,EndPoint epServer )
        {
            ...
            //capturedata = ALawEncoder.ALawEncode(capturedata);//语音编码
            try
            {
        ...
        {
            //byte[] byteDecodedData = new byte[intRecv * 2];
            //ALawDecoder.ALawDecode(bytRecv, out byteDecodedData); // G.711 decoding
